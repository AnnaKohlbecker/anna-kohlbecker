...
const JourneySection = () => {
  ...
  return (
    <CustomSection title="JOURNEY">
      <div className="relative">
        {/* Timeline line */}
        <div className="absolute left-6 top-0 bottom-0 w-0.5 bg-black border-l-2 border-dotted border-black bg-transparent"></div>

        <div className="space-y-12">
          {journeySteps.map((step, index) => (
            <div key={index} className="relative">
              {/* Icon positioned on timeline */}
              <div className="absolute left-0 w-12 h-12 bg-black rounded-xl flex items-center justify-center flex-shrink-0 z-10">
